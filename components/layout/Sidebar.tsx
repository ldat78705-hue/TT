...
const adminNavLinks = [
  ...
  { to: ROUTES.TEACHER_CALENDAR, icon: ICONS.teacherCalendar, label: 'Lịch dạy' },
  ...
  return (
    <>
      ...
      >
        ...
        <nav className="flex-1 p-3 md:p-4 overflow-y-auto pb-24 md:pb-4" aria-label="Danh sách menu">
          {navLinks.map(link => (
            <NavLink
              key={link.to}
              to={link.to}
